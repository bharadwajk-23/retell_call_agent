...
const API_BASE = "https://0591-103-248-208-170.ngrok-free.app";
...
async function loadPatients() {
    try {
        const response = await fetch(`https://0591-103-248-208-170.ngrok-free.app/patients`);
...
async function startCall(patient) {
    try {
        ...
        const response = await fetch(`https://0591-103-248-208-170.ngrok-free.app/start-call`, {
            method: 'POST',
...
function startTranscriptPolling(phone) {
    ...
    transcriptInterval = setInterval(async () => {
        try {
            const response = await fetch(`https://0591-103-248-208-170.ngrok-free.app/call-status?${params}`);
            if (response.ok) {
                const data = await response.json();
...
async function loadRecentCalls() {
    try {
        const response = await fetch(`https://0591-103-248-208-170.ngrok-free.app/transcripts`);
        const data = await response.json();
